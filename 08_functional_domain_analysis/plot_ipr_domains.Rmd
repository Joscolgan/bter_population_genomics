...
## Introduction:  
The following scripts takens a list of InterProScan domains of interest and plots a barchart using [ggplot2](https://ggplot2.tidyverse.org/). The script outputs a .png image as default.  
