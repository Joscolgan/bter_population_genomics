...
## Read in variant to plot by:
variants <- read.table(file = "./input/plot_snp_distance/gene_of_interests_variants.txt",
                       col.names = c("chrom",
                                     "position",
                                     "specific_variant",
                                     "general_variant",
...
## Add variant and locus information:
data_subset_df$variant <- variants$general_variant
data_subset_df$variant <- gsub("_", " ", data_subset_df$variant)
data_subset_df$locus <- variants$locus
```
...
distance_plot <- ggplot(data_subset,
        ...
        geom_point(data = data_subset_df,
                   ...
                   size = 3,
                   alpha = 0.8) +
        geom_label_repel(data = data_subset_df,
                      aes(label = locus),
                      size = 2) +
...
## Save to file:
ggsave(file = "results/plot_of_distance.png",
       height = 8,
       width = 12)
...
## Save to file:
ggsave(file = "results/plot_of_allele_frequencies.png",
       height = 8,
       width = 12)
