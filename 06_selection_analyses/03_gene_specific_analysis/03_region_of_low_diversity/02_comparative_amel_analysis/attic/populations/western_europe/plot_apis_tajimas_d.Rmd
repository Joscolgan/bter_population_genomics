...
## Plot:
plot_1 <- ggplot(summary_data_subset_part_1, aes(x = midpoint,
                                       y = tajima_d)) +
...
## Plot:
plot_2 <- ggplot(summary_data_subset_part_2, aes(x = midpoint,
                                       y = tajima_d)) +
        xlab("Gemomic position (bp)") +
        ylab("Tajima's D") +
        geom_point() +
...
```{r, message = FALSE}
combined_plot_western_euro <- ggarrange(plot_1,
                                  plot_2,
                                  plot_3)

## Save plot:
dir.create(path = "results/plots/")
save(combined_plot_western_euro, file = "results/plots/wEurope_plots.Rdata")
```
