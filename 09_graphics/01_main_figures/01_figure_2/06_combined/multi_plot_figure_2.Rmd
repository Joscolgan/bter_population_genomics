...
output: multi_plot_figure_2.html
...
3) A Manhattan plot of |nsl| scores;
4) A histogram of variant types;
5) A barchart of enriched Gene Ontology terms.  
The script generates a multi-image plot and outputs a graphic (.PDF, .PNG), as well as saved R object.
...
map_manhattan_and_hist_plot <- ggarrange(britain_map,
                                         manhattan_plot,
                                         variant_histogram,
                                     ncol = 3,
                                     nrow = 1,
...
8. Second, combine this plot with barchart (iii)
...
## Generate a combined plot:
pca_barchart_plot <- ggarrange(pca_plot,
                                    combined_terms_plot,
                                    ncol = 2,
                                    nrow = 1,
                                    labels = c("B",
...
9. Third, generate a final combined plot consisting of:
i) map, Manhattan and histogram on row 1;
ii) scatterplot of PCA and barchart plots on row 2:

```{r, message = FALSE}
## Generate combined plot:
combined_plot <- ggarrange(map_manhattan_and_hist_plot,
                           pca_barchart_plot,
                           ncol = 1,
                           nrow = 2,
                           heights = c(1, 1))
...
```{r, message = FALSE}
lintr::lint(file = "multi_plot_figure_2.Rmd")
```
