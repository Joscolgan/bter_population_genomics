...
This script creates a barchart of the number of significant genes annotated to a particular GO term, with an associated p-value. This script takes an input of .tsv files containing an output table of GO analyses.
...
3. Combine gene ontolgy terms for plotting:
