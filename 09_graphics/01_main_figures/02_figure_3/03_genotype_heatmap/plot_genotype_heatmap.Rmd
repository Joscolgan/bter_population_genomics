...
output: plot_genotype_heatmap.html
...
The output is a heatmap that is output in .PNG format, as well as saved as an R object.  
...
save(heatmap_plot, file = "results/plots/plot_genotype_heatmap.Rdata")
```
...
```{r, message = FALSE}
## Run lintr
lintr::lint(file = "plot_genotype_heatmap.Rmd")
```
