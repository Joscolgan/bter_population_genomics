...
The script outputs an R object containing the genotype heatmap that can be used by secondary scripts to generate a multi-image plot.
...
save(heatmap_plot,
     file = "results/plots/plot_genotype_heatmap.RData")
```
