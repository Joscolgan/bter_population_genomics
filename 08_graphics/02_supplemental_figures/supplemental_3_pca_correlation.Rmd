...
## Save as .png:
ggsave(file = "./results/supplemental_3_pca_correlation.png",
       height = 8,
       width = 10)

## Save as .pdf
ggsave(file = "./results/supplemental_3_pca_correlation.pdf",
       dpi = 600,
       height = 8,
       width = 10)
```
...
```{r, message = FALSE}
save.image(file = "results/supplemental_3_pca_correlation.RData")
```

Run lintr:

```{r, message = FALSE}
lintr::lint(file = "supplemental_3_pca_correlation.Rmd")
```
