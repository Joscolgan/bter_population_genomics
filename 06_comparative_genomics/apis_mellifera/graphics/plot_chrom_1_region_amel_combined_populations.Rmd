...
region_two_plot <- ggplot(combined_nd_melt,
        ...
        geom_hline(yintercept = c(nucdiv_median),
                   linetype = "dashed",
                   colour = "orange") +
        geom_vline(xintercept = 25028539) +
...
load(file = "./results/plots/chrom_1_region_1_snp_plot.Rdata")
load(file = "./results/plots/chrom_1_region_2_snp_plot.Rdata")
```
...
region_one_plot <- region_one_plot + theme(legend.position = "none")
