...
## Introduction:  
The purpose of this script is to take an R object containing gene-levels TPM counts as 
estimated by [tximport](https://bioconductor.org/packages/release/bioc/html/tximport.html),
convert to a dataframe and output as a text file.
