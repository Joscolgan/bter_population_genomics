...
bp_terms <- read.table(file = "results/output_100_ks/BP_sig.tsv",
                       header = TRUE)
bp_terms$category <- "BP"

## Read in molecular function GO terms:
mf_terms <- read.table(file = "results/output_100_ks/MF_sig.tsv",
                       header = TRUE)
mf_terms$category <- "MF"

## Read in molecular function GO terms:
cc_terms <- read.table(file = "results/output_100_ks/CC_sig.tsv",
                       header = TRUE)
