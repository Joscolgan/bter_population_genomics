...
load(file = "results/protein_domain_plus_stackedchart.RData")
```
...
```{r, message = FALSE}
output_file_name <- "figure_2_wolbachia_stacked"
...
```{r, message = FALSE}
save.image(file = "results/plots/wolbachia_combined_plot.RData")
```
