...
```{r, message = FALSE}
## Read in data:
nsl_data <- read.table(file = "./input/nsl_output/NC_015764.1.nsl.out.100bins.norm.abs.bed.tmp",
                       col.names = c("chrom",
                                     "position",
                                     "position",
                                     "nsl_score"))
ihs_data <- read.table(file = "./input/ihs_output/NC_015764.1.ihs.out.100bins.norm.abs.bed.tmp",
                       col.names = c("chrom",
                                     "position",
                                     "position",
                                     "ihs_score"))
recomb_data <- read.table(file = "./input/recombination_rate/NC_015764.1.recode.vcf.ldhelmet.ldhelmet.post.txt.tmp.genetic_map.txt.recomb.txt",
                          header = TRUE)
...
## Save:
ggsave(file = "results/uncharacterised_protein_combined_plot.png",
       width = 10,
       height = 20)
