...
output: plot_transcription_factor_sweep.html
...
ihs_data <- read.table(file = "./input/ihs_output/NC_015765.1.ihs.out.100bins.norm.abs.bed.tmp",
                       col.names = c("chrom",
                                     ...
                                     "position",
                                     "ihs_score"))
recomb_data <- read.table(file = "./input/recombination_rate/NC_015765.1.recode.vcf.ldhelmet.ldhelmet.post.txt.tmp.genetic_map.txt.recomb.txt",
                          header = TRUE)
