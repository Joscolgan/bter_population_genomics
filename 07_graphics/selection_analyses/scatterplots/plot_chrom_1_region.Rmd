...
nuc_div_data_10kb <- read.table(file = "./input/nucleotide_diversity_output/bter_all_chrom_10kb.txt",
                           header = TRUE)

nuc_div_data_100kb <- read.table(file = "./input/nucleotide_diversity_output/bter_all_chrom_100kb_filtered.txt",
                           col.names = c("chrom",
                                         "start",
                                         "end",
...
## Save as an R object:
save(nuc_div_plot,
     file = "./results/large_sweep_chrom_one_combined_plot.Rdata")
```
