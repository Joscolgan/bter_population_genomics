...
```{r, message = FALSE}
## Define input:
input_vcf <- "./input/vcf_input/regions_of_interest/chrom_1_region.recode.vcf"
...
positions <- read.table("./input/vcf_input/regions_of_interest/chrom_1_region.positions.txt",
                        header = FALSE)
