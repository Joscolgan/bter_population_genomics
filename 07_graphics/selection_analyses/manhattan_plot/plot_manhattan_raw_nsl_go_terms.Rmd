...
```{r, message = FALSE}
## Read in variants:
variants <- read.table(file = "./subset_tmp/input_for_r_annotated.txt",
                       col.names = c("CHR",
                                     "BP",
                                     "P",
                                     "variant",
...
peaks <- read.table(file = "./input/nsl_output/top_50_genes/input_for_plot_top20.txt",
                    col.names = c("CHR",
                                  "BP",
                                  "P",
                                  "locus"))
...
ggsave(file = "./manhattan_plot.png",
       height = 8,
       width = 10)
```
...
```{r, message = FALSE}
## Run lintr:
lintr::lint(file = "./plot_manhattan_raw_nsl_go_terms.Rmd")
```