...
load(file = "large_sweep_chrom_one_combined_plot.Rdata")
...
Plot nucleotide diversity across 100kb chunks:
...
load(file = "input/combined_apis_plots.Rdata")
```
...
## Save:
ggsave(file = "results/apidae_sweep_chrom_one_combined_plot.pdf",
       dpi = 600,
       width = 10,
       height = 8)

ggsave(file = "results/apidae_sweep_chrom_one_combined_plot.png",
       width = 10,
       height = 8)
...
For talk:
```{r, message = FALSE}
talk_slide <- ggarrange(arrow_plot,
          nuc_div_plot,
          nrow = 2,
          ncol = 1,
          heights = c(0.7,
...
ggsave(file = "results/plots/large_sweep_chrom_one_combined_plot_talk.png",
       width = 10,
       height = 8)
...
ggsave(file = "results/plots/large_sweep_chrom_one_combined_plot_histo_talk.png",
       width = 10,
       height = 8)
```
...
## Save:
ggsave(file = "results/plots/large_sweep_chrom_one_combined_plot_alt.png",
       width = 12,
       height = 10)
```
