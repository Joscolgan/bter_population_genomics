...
nsl_ranked_file <- "./input/gene_length_correct/nsl_scores_per_gene.txt"
...
nsl_ranked_sorted_filtered$nsl_corrected_by_length <- nsl_ranked_sorted_filtered$nsl_score/nsl_ranked_sorted_filtered$length

nsl_ranked_sorted_filtered <- nsl_ranked_sorted_filtered[order(-nsl_ranked_sorted_filtered$nsl_corrected_by_length), ]

## Read in GO annotations:  
gene_to_go_mapping <- readMappings(file = gene_to_go_mapping_file)

## Convert into topgo's genelist format:
topgo_genelist        <- nsl_ranked_sorted_filtered$nsl_corrected_by_length
