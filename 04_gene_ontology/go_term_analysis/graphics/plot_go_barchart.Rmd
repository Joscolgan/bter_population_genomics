...
bp_terms <- read.table(file = "results/output_50_ks_bonferroni/BP_sig.tsv",
                       header = TRUE)
bp_terms$category <- "BP"

## Read in molecular function GO terms:
mf_terms <- read.table(file = "results/output_50_ks_bonferroni/MF_sig.tsv",
                       header = TRUE)
mf_terms$category <- "MF"

## Read in molecular function GO terms:
cc_terms <- read.table(file = "results/output_50_ks_bonferroni/CC_sig.tsv",
                       header = TRUE)
