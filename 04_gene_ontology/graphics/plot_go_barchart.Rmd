...
bp_terms <- read.table(file = "input/gene_ontology_input/BP_sig.tsv",
                       header = TRUE)
bp_terms$category <- "BP"

## Read in molecular function GO terms:
mf_terms <- read.table(file = "input/gene_ontology_input/MF_sig.tsv",
                       header = TRUE)
mf_terms$category <- "MF"

## Read in molecular function GO terms:
cc_terms <- read.table(file = "input/gene_ontology_input/CC_sig.tsv",
                       header = TRUE)
